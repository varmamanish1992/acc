...
const string strMessageMagic = "AUXYCOIN Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            int64_t nSubsidy = 32 * COIN;

            if(nBestHeight == 0)
            {
            nSubsidy = 7236923 * COIN;
            }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "AUXYCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1510836018, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "This First Time Build AUXYCOIN at 16 nov 2017";
        CTransaction txNew;
        txNew.nTime = 1510836018;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1510836018;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1224004 : 1224004;
        ...
        assert(block.hashMerkleRoot == uint256("0x7c55af6f3dea0cb4edd892be712ded3938be94df4bb032ee3b9f1603ebdce3a6"));
...
unsigned char pchMessageStart[4] = { 0xed, 0xfd, 0xa8, 0x24 };
